...
| `地基/11-语言规范-v1.md` | Language spec v1.1 (archived as a design study; the surface grammar is deferred) |
| `地基/12-IR与类契约-v0.1.md` | Current authority: class contract, six-form IR, checker rules J-01…J-18, passes, Python builder, build order |
